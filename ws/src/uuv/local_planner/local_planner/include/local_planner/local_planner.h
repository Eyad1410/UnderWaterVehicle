...
#ifndef UUV_LOCAL_PLANNER_H_
#define UUV_LOCAL_PLANNER_H_
...
class Local_Planner : public rclcpp::Node {
    ...
    public:
      ...
      uuv_sys_core::PlannerState computeVelocityCommand(std::string traj_gen_name, base_trajectory::Trajectory& best_traj);
